...
/-
I used chatgpt for this assignment. It was only useful in explaiing the inductive data types and helped later on with part 2 in explaining what and how
all of the symbols and propositions worked. Like usual, helps with understanding the logic in english, terrible at everyhing else. 
-/